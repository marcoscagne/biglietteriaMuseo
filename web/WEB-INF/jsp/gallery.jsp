<%-- 
    Document   : gallery
    Created on : 27-apr-2016, 12.57.12
...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <style type="text/css">
            ...
            body {margin: 0; padding-bottom:50px; background:#333 url(./resources/img/imgsG/sw_page_bg.png); overflow:hidden; font-family:Helvetica, Arial, sans-serif; font-size:16px;}
            /* custom fonts */
            @font-face {
            ...
            #customScrollBox{position:relative; overflow:hidden; background:url(./resources/img/imgsG/sw_l_bg.png) repeat-y;}
            ...
            #customScrollBox a.thumb_link .selected{position:absolute; top:0; left:0; width:145px; height:91px; background:url(./resources/img/imgsG/sw_thumb_selected.png) no-repeat; display:none;}
            #dragger_container{position:relative; width:30px; height:580px; float:left; margin:10px 0 0 0; background:url(./resources/img/imgsG/sw_dragger_bg.png) repeat-y center;}
            #dragger{position:absolute; width:30px; height:59px; background:url(./resources/img/imgsG/round_custom_scrollbar_bg.png) no-repeat center center; cursor:pointer;}
            #arrow_indicator{position:absolute; z-index:1; width:50px; padding:10px; top:50%; margin-top:-25px; left:20px; background:url(./resources/img/imgsG/sw_transparent_black_bg.png); -moz-border-radius:5px; -khtml-border-radius:5px; -webkit-border-radius:5px; border-radius:5px; display:none;}
            #nextimage_tip{position:fixed; z-index:1; padding:0 20px; line-height:40px; color:#fff; height:40px; top:50%; margin-top:-20px; right:20px; background:url(./resources/img/imgsG/sw_transparent_black_bg.png); -moz-border-radius:5px; -khtml-border-radius:5px; -webkit-border-radius:5px; border-radius:5px; display:none; font-family:graublauweb-webfont, Helvetica, Arial, sans-serif;}
    ...
    <body>
            ...
            <div id="customScrollBox">
                ...
                <div class="container">
                    <div class="content">
                        ...
                        <a href="./resources/img/imgsG/2.jpg" class="thumb_link"><span class="selected"></span><img src="./resources/img/imgsG/2.jpg" width="145" class="thumb" /></a>
                        <a href="./resources/img/imgsG/3.jpg" class="thumb_link"><span class="selected"></span><img src="./resources/img/imgsG/3.jpg" width="145" class="thumb" /></a>
                        <a href="./resources/img/imgsG/4.jpg" class="thumb_link"><span class="selected"></span><img src="./resources/img/imgsG/4.jpg" width="145" class="thumb" /></a>
                        <a href="./resources/img/imgsG/5.jpg" class="thumb_link"><span class="selected"></span><img src="./resources/img/imgsG/5.jpg" width="145" class="thumb" /></a>
                        <a href="./resources/img/imgsG/6.jpg" class="thumb_link"><span class="selected"></span><img src="./resources/img/imgsG/6.jpg" width="145" class="thumb" /></a>
                        <a href="./resources/img/imgsG/7.jpg" class="thumb_link"><span class="selected"></span><img src="./resources/img/imgsG/7.jpg" width="145" class="thumb" /></a>
                        <a href="./resources/img/imgsG/8.jpg" class="thumb_link"><span class="selected"></span><img src="./resources/img/imgsG/8.jpg" width="145" class="thumb" /></a>
                        <a href="./resources/img/imgsG/10.jpg" class="thumb_link"><span class="selected"></span><img src="./resources/img/imgsG/10.jpg" width="145" class="thumb" /></a>
                        <a href="./resources/img/imgsG/11.jpg" class="thumb_link"><span class="selected"></span><img src="./resources/img/imgsG/11.jpg" width="145" class="thumb" /></a>
                        <a href="./resources/img/imgsG/12.jpg" class="thumb_link"><span class="selected"></span><img src="./resources/img/imgsG/12.jpg" width="145" class="thumb" /></a>
                        <a href="./resources/img/imgsG/1.jpg" class="thumb_link"><span class="selected"></span><img src="./resources/img/imgsG/1.jpg" width="145" class="thumb" /></a>
                        <a href="./resources/img/imgsG/2.jpg" class="thumb_link"><span class="selected"></span><img src="./resources/img/imgsG/2.jpg" width="145" class="thumb" /></a>
                        <a href="./resources/img/imgsG/3.jpg" class="thumb_link"><span class="selected"></span><img src="./resources/img/imgsG/3.jpg" width="145" class="thumb" /></a>
                        <a href="./resources/img/imgsG/4.jpg" class="thumb_link"><span class="selected"></span><img src="./resources/img/imgsG/4.jpg" width="145" class="thumb" /></a>
                        ...
                        <a href="./resources/img/imgsG/4.jpg" class="thumb_link"><span class="selected"></span><img src="./resources/img/imgsG/4.jpg" width="145" class="thumb" /></a>
                        <p class="clear"></p>
                        <p>Copyright<sup>&copy;</sup> Musei Belli 2016</p>
                    </div>
                </div>
        ...
        <script>
                ...
                function CustomScroller() {
                    ...
                    if ($customScrollBox_container.height() > visibleHeight) { //custom scroll depends on content height
                        ...
                        function DraggerOver() {
                            $dragger.css("background", "url(./resources/img/imgsG/round_custom_scrollbar_bg_over.png)");
                        }

                        function DraggerOut() {
                            $dragger.css("background", "url(./resources/img/imgsG/round_custom_scrollbar_bg.png)");
                        }
            ...
            var images = ["./resources/img/imgsG/ajax-loader_dark.gif", "./resources/img/imgsG/round_custom_scrollbar_bg_over.png"];
