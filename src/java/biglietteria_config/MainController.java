...
public class MainController {
    ...
    public String confReg(ModelMap map, @RequestParam(value = "nome", required = true) String nome, @RequestParam(value = "cognome", required = true) String cognome, @RequestParam(value = "email", required = true) String email, @RequestParam(value = "nu", required = true) String nu, @RequestParam(value = "pass", required = true) String pass) {
        String msg = "";
        Clienti cl = new Clienti(nu, pass, nome, cognome, email);
        CRUD c = new CRUD(HibernateUtil.getSessionFactory());
    ...
    public String modificaProfilo(ModelMap map, @RequestParam(value = "nome", required = true) String nome, @RequestParam(value = "cognome", required = true) String cognome, @RequestParam(value = "email", required = true) String email, @RequestParam(value = "nu", required = true) String nu, @RequestParam(value = "pass", required = true) String pass) {
        String msg = "";
        Clienti cl = new Clienti(nu, pass, nome, cognome, email);
        CRUD c = new CRUD(HibernateUtil.getSessionFactory());
    ...
    public String compra(ModelMap map, @RequestParam(value = "id", required = true) Integer id, @RequestParam(value = "data", required = true) String data, @RequestParam(value = "cat", required = true) Integer cat) {
        ...
        map.put("categoria", c.categoria(cat));
        return "compra";
    }
    ...
    public String end(ModelMap map, @RequestParam(value = "data", required = true) String dataN, @RequestParam(value = "user", required = true) String user, @RequestParam(value = "costo", required = true) BigDecimal costo, @RequestParam(value = "idAtt", required = true) Integer idAtt, @RequestParam(value = "cat", required = true) Integer cat) {
        ...
        Categorie categ = c.categoria(cat);
        ...
        map.put("data", dataN);
        map.put("costo", costo);
        map.put("sconto", categ.getPercSconto());
        map.put("idAtt", idAtt);
        return "acquistato";
    }
    /*
    ...
    public String end(ModelMap map){
        String msg="AcquistoAvvenutoConSuccesso!";
        map.put("msg", msg);
        CRUD c = new CRUD(HibernateUtil.getSessionFactory());
        map.put("attivita", c.listAttivita());
        return "index";
